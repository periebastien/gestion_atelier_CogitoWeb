<?php
// Séparateur des titres de page (« — » interdit dans les contenus, 09/09/2026).
add_filter( 'document_title_separator', static function () { return '·'; }, 20 );
/**
...
require_once __DIR__ . '/includes/gacct-workorder-pdf.php';
require_once __DIR__ . '/includes/gacct-quote.php';
require_once __DIR__ . '/includes/gacct-docs.php';
...
require_once __DIR__ . '/includes/gacct-secours-rappel.php'; // rappel annuel de pliage : cron, e-mails, desabonnement (09/09/2026)
		...
		return array(
			...
			4 => array(
				...
				'body'       => '<p>Bonjour {customer_name},</p>'
					...
					. '<p>Merci de votre réactivité,<br><br>' . gacct_team_signature() . '</p>',
			),
			6 => array(
				'enabled'    => true,
