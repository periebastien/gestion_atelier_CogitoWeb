<?php
/**
 * Paiement Altitude Révision — surcharge de woocommerce/checkout/payment.php
 * (porté du checkout AEROTECH le 07/08/2026)
 *
...
<div id="payment" class="woocommerce-checkout-payment at-pay">
	...
	<div class="form-row place-order at-co-place">
		...
		<span class="at-co-secure">Paiement sécurisé — aucune donnée bancaire n'est stockée par <?php echo esc_html( get_bloginfo( 'name' ) ); ?>.</span>
